"""This file contains the transforms for the dataset"""
...
def get_train_transforms(image_height, image_width):
    ...
    - train_transforms (albumentations.Compose):
            The train transforms for the dataset.
    - val_transforms (albumentations.Compose):
            The validation transforms for the dataset.

    Example usage:
    ------------
    train_transforms, val_transforms = get_transforms(256, 256)
